  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", UiEdColumn = (_dec = ccclass('UiEdColumn'), _dec2 = menu('cwg/UiEdColumn'), _dec3 = property(UITransform), _dec4 = property(Node), _dec5 = property(_crd && CwgPools === void 0 ? (_reportPossibleCrUseOfCwgPools({
        ...
        createGlass() {
          // 从对象池获取可编辑玻璃瓶实例
          const glass = this.glassPools.getGlass(); // 初始化玻璃瓶参数（位置、颜色等）
        ...
        reset(stageConfigs) {
          ...
          for (let i = 0; i < stageConfigs.length; i++) {
            ...
            const glass = node.getComponent(_crd && Glass === void 0 ? (_reportPossibleCrUseOfGlass({
              error: Error()
            }), Glass) : Glass);
...
//# sourceMappingURL=37f39e80fc6a5958cbc6c7950c9c12b637a071ab.js.map