    ...
    execute: function () {
      ...
      _export("default", Glass = (_dec = ccclass('Glass'), _dec2 = menu('cwg/Glass'), _dec3 = property({
        ...
        updateShadowOpacity() {
          ...
          const uiOpacity = this.shadowNode.getComponent(UIOpacity); // 【安全检查】确保组件存在
        ...
        setWater(index, waterColor, black2color) {
          ...
          const surfaceSprite = (_waterNode$children$ = waterNode.children[0]) == null ? void 0 : _waterNode$children$.getComponent(Sprite);
          if (!waterSprite || !surfaceSprite) return; // 安全检查

          const baseColor = new Color((_crd && WaterColors === void 0 ? (_reportPossibleCrUseOfWaterColors({
            error: Error()
          }), WaterColors) : WaterColors)[waterColor].base);
          const surfaceColor = new Color((_crd && WaterColors === void 0 ? (_reportPossibleCrUseOfWaterColors({
            error: Error()
...
//# sourceMappingURL=a86f67c137dc20e4630202c69c025b7ebe6fde60.js.map