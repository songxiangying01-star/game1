      ...
      _export("default", GlassPourOut = (_dec = ccclass('GlassPourOut'), _dec2 = menu('cwg/GlassPourOut'), _dec3 = property(Animation), _dec4 = property(Node), _dec5 = property([Sprite]), _dec(_class = _dec2(_class = (_class2 = class GlassPourOut extends (_crd && Glass === void 0 ? (_reportPossibleCrUseOfGlass({
        ...
        pickUpMoveTo(from, to) {
          ...
          if (this.shadowNode) {
            ...
            var targetX = 380 * this.node.scale.x;
            var targetPos = new Vec3(targetX, 22, this.shadowNode.position.z);
            tween(this.shadowNode).to(0.3, {
              position: targetPos
            }).start();
            var uiOpacity = this.shadowNode.getComponent(UIOpacity);
        ...
        putDownBack() {
          var layerID = this.startColumnIndex + 1;
          var speed = [0, 6, 5, 4, 3][layerID];
          var tw = tween(this.node).to((0.666 + (5 - layerID) * 0.333) / speed, {
        ...
        pourOutFinish(currentLayerIdx) {
          ...
          if (currentLayerIdx == this.startColumnIndex) {
            ...
            for (var i = 3; i >= this.startColumnIndex; i--) {
              this.watersNode.children[i].active = false;
            }

            var animState = this.anim.getState(this.anim.defaultClip.name);
            var currentTime = animState.time; // Get current playback time
        ...
        showNextLayerSurface(index) {
          ...
          if (nextIndex >= 0) {
            var nextNode = this.watersNode.children[nextIndex];
        ...
        pourOutStart(layerIdx) {
          ...
          if (layerIdx >= this.startColumnIndex && layerIdx < this.waters.length) {
            ...
            var colorIdx = this.waters[layerIdx];
            ...
            var _color = new Color().fromHEX((_crd && WaterColors === void 0 ? (_reportPossibleCrUseOfWaterColors({
              error: Error()
...
//# sourceMappingURL=47f7cadd6047077d72fb48ae8fbaa8fc314fc5d9.js.map