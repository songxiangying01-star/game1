      ...
      _export("default", UiEdColorCount = (_dec = ccclass('UiEdColorCount'), _dec2 = menu('cwg/UiEdColorCount'), _dec3 = property(Node), _dec4 = property(Label), _dec(_class = _dec2(_class = (_class2 = class UiEdColorCount extends Component {
        ...
        calculateTotalWaterSegments() {
          ...
          this.columnsContent.children.forEach(node => {
            ...
            var item = node.getComponent(_crd && UiEdColumn === void 0 ? (_reportPossibleCrUseOfUiEdColumn({
              error: Error()
            }), UiEdColumn) : UiEdColumn);
            item.glassesNode.children.forEach(node => {
              var glass = node.getComponent(_crd && EdGlass === void 0 ? (_reportPossibleCrUseOfEdGlass({
                error: Error()
              }), EdGlass) : EdGlass);
        ...
        updateColorConfiguration() {
          ...
          var totalSegments = Math.floor(this.calculateTotalWaterSegments() / 4);
          ...
          var colors = [];
          var color = (_crd && WaterColor === void 0 ? (_reportPossibleCrUseOfWaterColor({
            error: Error()
          ...
          this.columnsContent.children.forEach(node => {
            ...
            for (var _i2 = 0, len = item.glassesNode.children.length; _i2 < len; _i2++) {
              var _node = item.glassesNode.children[_i2];

              var glass = _node.getComponent(_crd && EdGlass === void 0 ? (_reportPossibleCrUseOfEdGlass({
                error: Error()
              }), EdGlass) : EdGlass);
...
//# sourceMappingURL=955449ded0e9aa0eaccbda79ca1f582396da2e87.js.map