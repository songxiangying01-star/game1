      ...
      _export("VwPlay", VwPlay = (_dec = ccclass('VwPlay'), _dec2 = menu('cwg/VwPlay'), _dec3 = property(_crd && VwFunland === void 0 ? (_reportPossibleCrUseOfVwFunland({
        ...
        restartLevel() {
          ...
          return _asyncToGenerator(function* () {
            // 【安全检查】防止对象为空导致报错
            if (!_this.gameState || !_this.funland || !_this.play || !_this.ui) {
              console.error("无法重启关卡：关键组件或数据丢失！"); // 如果失败了也要解锁，否则游戏就卡死了

              _this.isSwitchingLevel = false;
              return;
            }
            ...
            _this.play.reset(_this.funland);

            _this.ui.reset(_this.gameState.info); // 开始游戏


            _this.play.playStart(); // 【关键修复】新关卡加载完成，解锁，允许下一次切换
...
//# sourceMappingURL=704b76e8fc35b64c6d8b02844ab975784afd0e67.js.map